                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            {!! \Helper\Field::select('category_id',__('courses::dashboard.courses.form.categories'),pluckModelsCols(
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('courses::dashboard.courses.datatable.doctor')}}</th>
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'doctor', className: 'dt-center'},
