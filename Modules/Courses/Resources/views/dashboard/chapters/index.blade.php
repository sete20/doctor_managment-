                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.chapters.create')) }}"
                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            {!! \Helper\Field::select('category_id',__('courses::dashboard.chapters.form.categories'),pluckModelsCols(
                        ...
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.chapters.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.chapters.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                      ...
                      `;
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Edit
                                var editUrl = '{{ route("dashboard.chapters.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.chapters.destroy", ":id") }}';
