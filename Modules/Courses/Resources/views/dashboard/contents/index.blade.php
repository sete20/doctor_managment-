                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a href="{{ url(route('dashboard.cards.create')) }}">
                                                        {{__('courses::dashboard.contents.btn.add_card')}}
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url(route('dashboard.quiz.create')) }}">
                                                        {{__('courses::dashboard.contents.btn.add_quiz')}}
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ url(route('dashboard.videos.create')) }}">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.contents.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                switch (full.type) {
                                    case 'video':
                                        // Edit
                                        editUrl = '{{ route("dashboard.videos.edit", ":id") }}';
                                        editUrl = editUrl.replace(':id', data);
                                        // Show
                                        showUrl = '{{ route("dashboard.videos.show", ":id") }}';
                                        showUrl = showUrl.replace(':id', data);
                                        break;
                                    case 'card':
                                        // Edit
                                        editUrl = '{{ route("dashboard.cards.edit", ":id") }}';
                                        editUrl = editUrl.replace(':id', data);
                                        break;
                                    case 'quiz':
                                        // Edit
                                        editUrl = '{{ route("dashboard.quiz.edit", ":id") }}';
                                        editUrl = editUrl.replace(':id', data);
                                        // Show
                                        showUrl = '{{ route("dashboard.quiz.show", ":id") }}';
                                        showUrl = showUrl.replace(':id', data);
                                ...
                                // Delete
                                var deleteUrl = '{{ route("dashboard.contents.destroy", ":id") }}';
