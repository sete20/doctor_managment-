...
@section('title', __('courses::dashboard.contents.videos.routes.create'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('courses::dashboard.contents.videos.routes.create')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                {!! Form::model($model,[
                                'url'=> route('dashboard.videos.store'),
                                'id'=>'form',
                                'role'=>'form',
                                'method'=>'POST',
