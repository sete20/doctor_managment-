...
@section('title', __('courses::dashboard.contents.videos.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('courses::dashboard.contents.videos.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            {!! Form::model($model,[
                            'url'=> route('dashboard.videos.update',$model->id),
                            'id'=>'updateForm',
                            'role'=>'form',
                            'page'=>'form',
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                            <li class="active">
                                                <a href="#global_setting" data-toggle="tab">
                                                    {{ __('courses::dashboard.contents.videos.form.tabs.general') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <h3 class="page-title">{{__('courses::dashboard.contents.videos.form.tabs.general')}}</h3>
                                <div class="col-md-10">
                                    @include('courses::dashboard.contents.videos.form')
                                </div>
                            </div>
                            {{-- END UPDATE FORM --}}
