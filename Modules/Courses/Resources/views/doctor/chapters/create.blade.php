...
@section('title', __('courses::dashboard.chapters.routes.create'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ url(route('doctor.chapters.index')) }}">
                            {{__('courses::dashboard.chapters.routes.index')}}
                        </a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <a href="#">{{__('courses::dashboard.chapters.routes.create')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                {!! Form::model($model,[
                                'url'=> route('doctor.chapters.store'),
                                'id'=>'form',
                                'role'=>'form',
                                'method'=>'POST',
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="general">
                                    ...
                                    <div class="col-md-10">
                                        @include('courses::doctor.chapters.form')
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-actions">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{url(route('doctor.chapters.index')) }}" class="btn btn-lg red">
