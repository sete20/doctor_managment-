...
{!! Helper\FieldV2::select('course_id',__('courses::dashboard.chapters.form.course'),pluckModelsCols($chapters->DoctorScope()->get() ,'id','title',false,true)) !!}
                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            ...
                            <a
                                    href="javascript:;"
                                    onclick="deleteRow('{{url(route('doctor.chapters.resources.delete',[$model->id,'resources',$media->id]))}}',{{$media->id}})"
