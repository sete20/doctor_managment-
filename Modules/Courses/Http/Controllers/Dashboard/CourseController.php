...
use Modules\Courses\Http\Requests\Dashboard\CourseRequest;
use Modules\Courses\Transformers\Dashboard\CourseResource;
use Modules\Courses\Repositories\Dashboard\CourseRepository;
...
class CourseController extends Controller
{
    ...
    {
        return view('courses::dashboard.courses.index');
    }
    ...
    {
        $model = $this->model;
        return view('courses::dashboard.courses.create' , compact('model'));
    }
    ...
    {
        return view('courses::dashboard.courses.show');
    }

    public function edit($id)
    {
        $model = $this->course->findById($id);
        return view('courses::dashboard.courses.edit',compact('model'));
    }
