...
use Modules\Courses\Http\Requests\Doctor\ChapterRequest;
use Modules\Courses\Transformers\Doctor\ChapterResource;
use Modules\Courses\Repositories\Doctor\ChapterRepository;
...
class ChapterController extends Controller
{
    ...
    {
        return view('courses::doctor.chapters.index');
    }
    ...
    {
        $model = $this->model;
        return view('courses::doctor.chapters.create' , compact('model'));
    }
    ...
    {
        return view('courses::doctor.chapters.show');
    }

    public function edit($id)
    {
        $model = $this->chapter->findById($id);
        return view('courses::doctor.chapters.edit',compact('model'));
    }
