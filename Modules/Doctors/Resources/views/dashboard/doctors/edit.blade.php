...
@section('title', __('doctors::dashboard.doctors.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('doctors::dashboard.doctors.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            {!! Form::model($model,[
                            'url'=> route('dashboard.doctors.update',$model->id),
                            'id'=>'updateForm',
                            'role'=>'form',
                            'page'=>'form',
