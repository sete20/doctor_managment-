...
@section('title', __('users::dashboard.admins.index.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('users::dashboard.admins.index.title')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('users::dashboard.admins.datatable.name')}}</th>
                                    <th>{{__('users::dashboard.admins.datatable.email')}}</th>
                                    <th>{{__('users::dashboard.admins.datatable.mobile')}}</th>
                                    <th>{{__('users::dashboard.admins.datatable.created_at')}}</th>
                                    <th>{{__('users::dashboard.admins.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                    ...
                    columnDefs: [
                      ...
                      `;
                        ...
                        },
                        {
                            targets: -1,
                            width: '13%',
                            title: '{{__('users::dashboard.admins.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {
