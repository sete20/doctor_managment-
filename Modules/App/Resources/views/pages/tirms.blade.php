        ...
        <div class="container">
            <div class="site-header-inner">
                <div class="brand header-brand">
                    <h1 class="m-0">
                        <a href="#">
                            <img class="header-logo-image asset-light" src="{{asset('front/dist/images/logo-light.svg')}}" alt="Logo">
                            <img class="header-logo-image asset-dark" src="{{asset('front/dist/images/logo-dark.svg')}}" alt="Logo">
                        </a>
                    </h1>
                </div>
            </div>
